...
cv2.namedWindow('Real Time Gaming Using Gestures With Pose Detection', cv2.WINDOW_NORMAL)
...
while camera_video.isOpened():
    ...
    cv2.imshow('Real Time Gaming Using Gestures With Pose Detection', frame)
